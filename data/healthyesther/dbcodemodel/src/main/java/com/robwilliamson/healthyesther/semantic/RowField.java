...
public class RowField extends BaseField {
    ...
    public RowField(JFieldVar fieldVar, Column column, RowGenerator rowGenerator) {
    ...
    public RowField(JDefinedClass owningClass, Column column, RowGenerator rowGenerator) {
