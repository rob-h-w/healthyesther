    ...
    implements Serializable
{
    ...
    @Nonnull
    public MedicationTable.Row select1(
        @Nonnull
        Database database,
        @Nonnull
        Where where) {
        MedicationTable.Row row = select0Or1(database, where);
        if (row == null) {
        ...
        implements Serializable, Key
    {
        ...
        @Override
        public int hashCode() {
            int hash = MedicationTable.PrimaryKey.class.getCanonicalName().hashCode();
