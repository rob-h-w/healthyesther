    ...
    implements Serializable
{
        ...
        implements Serializable, Key
    {
        ...
        @Override
        public int hashCode() {
            int hash = EventTypeTable.PrimaryKey.class.getCanonicalName().hashCode();
        ...
        implements Serializable
    {
        ...
        @Nullable
        private com.robwilliamson.healthyesther.db.generated.EventTable.Row[] mEventTypeId;
        ...
        public void loadAllRelations(Database database) {
            mEventTypeId = HealthDatabase.EVENT_TABLE.select(database, WhereContains.foreignKey("type_id", getConcretePrimaryKey().getId()));
        }

        @Nullable
        public com.robwilliamson.healthyesther.db.generated.EventTable.Row[] getEventTypeId() {
            return mEventTypeId;
        }
