    ...
    implements Serializable
{
        ...
        implements Serializable, Key
    {
        ...
        @Override
        public int hashCode() {
            int hash = UnitsTable.PrimaryKey.class.getCanonicalName().hashCode();
        ...
        implements Serializable
    {
        ...
        @Nullable
        private com.robwilliamson.healthyesther.db.generated.MealEventTable.Row[] mMealEventUnitsId;
        ...
        public void loadAllRelations(Database database) {
            mMealEventUnitsId = HealthDatabase.MEAL_EVENT_TABLE.select(database, WhereContains.foreignKey("units_id", getConcretePrimaryKey().getId()));
        }

        @Nullable
        public com.robwilliamson.healthyesther.db.generated.MealEventTable.Row[] getMealEventUnitsId() {
            return mMealEventUnitsId;
        }
